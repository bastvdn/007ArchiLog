 ...
 * its generated by concatenating all the small boxes (announcement, enemy,...) inside the borderWindow
 *
 * */
public class UI {
    ...
    /*
     * getters and setters for useful variable
    ...
    * */
     ...
     * it was kept separated to be easily modifiable, thus there is a bit of voluntary code replication. (in theory two boxes could be completely different, not the case here)
     * */
    ...
    /*
     * resets announcements display (side scrolling Bar with all game information)
     * */
    ...
    /*
     * update enemy box (Hp bar changing)
     * */
    ...
    * There is a bit of code replication here but we want announcement to be easily created and dynamic, anyone ca create a new announcement
    * */
    public void announce(String s){
        ...
        if(s.equals("mobInfo")){
            ...
            this.announcementList.add("you encounter a NEW ENEMY");
            this.announcementList.add("↓   ↓   ↓   ↓   ↓   ↓   ↓ ");
        ...
        if (s.equals("dropGun")){
            ...
            String str = "You dropped : " + game.mob.getWeapon().getClass().getSimpleName() + " Do you want it?" ;
            String str1 = "current weapon : " +game.player.getWeapon().getClass().getSimpleName() +
                    "--> Additional damages :" + game.player.getWeapon().damage();
            String str2 = " Bullet cost :" + game.player.getWeapon().bps() +" LifeSteal :" + game.player.getWeapon().lifeSelfImpact();
            String str3= game.mob.getWeapon().getClass().getSimpleName()  + "--> Additional damages :" + game.mob.getWeapon().damage();
        ...
        if (s.equals("dropArmor")){
            ...
            String str = "You Dropped : " + game.mob.getArmor().getClass().getSimpleName() + " Do you want it?" ;
